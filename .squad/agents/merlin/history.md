...
- "Ed Knox" + "FiServ DC exit" → "Weekly sync message on datacenter migration" (lines ~756-758)
- "FiServ DC exit thread" → "Datacenter migration thread" (lines ~790-794)
- "FiServ" in embedded citation label → "Contoso" (line ~859)
