...
<section bind:this={sectionEl} class="relative py-24 md:py-32">
	...
	>
		...
		<p class="text-lg text-white/50 mb-12">Get FlightDeck on your machine in seconds.</p>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
			...
			<div class="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
				...
				<div class="rounded-lg bg-black/40 p-3 font-mono text-sm text-white/70 border border-white/5">
					<span class="text-white/30 select-none">❯ </span>winget install FlightDeck.FlightDeck
				</div>
			</div>
			...
			<div class="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
				...
				<div class="rounded-lg bg-black/40 p-3 font-mono text-xs text-white/70 border border-white/5 space-y-1">
					<div><span class="text-white/30 select-none">❯ </span>git clone …FlightDeck</div>
					<div><span class="text-white/30 select-none">❯ </span>npm install && npm start</div>
				</div>
			</div>
		</div>
